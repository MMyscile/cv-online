    ...
    <section className="py-20 px-6 bg-[var(--cv-beige)]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-start">
          {/* Texte à gauche */}
          <div className="relative text-gray-600 leading-relaxed space-y-4 text-[15px] pl-8">
            {/* Quote mark décorative - ouverture */}
            <svg
              className="absolute -top-2 left-0 w-6 h-6 text-[var(--cv-green)] opacity-30"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
