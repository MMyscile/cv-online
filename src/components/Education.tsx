    ...
    <section className="py-20 px-6 bg-[var(--cv-beige)]">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8 mb-20">
          {/* POEC */}
          <div className="relative pl-8 border-l-2 border-[var(--cv-green-light)] hover:border-[var(--cv-green)] transition-colors">
            <div className="absolute -left-2 top-0 w-4 h-4 bg-white border-2 border-[var(--cv-green)] rounded-full"></div>
            ...
            <ul className="text-gray-500 text-sm space-y-1">
              <li className="flex items-start gap-2">
                <span className="w-1 h-1 bg-[var(--cv-green)] rounded-full mt-2 flex-shrink-0"></span>
            ...
            <div className="mt-4 space-y-4">
              <div className="bg-white rounded-lg p-4 shadow-sm">
                <div className="flex items-center gap-2 mb-3">
                  <span className="text-xs font-medium bg-[var(--cv-green-light)] text-[var(--cv-green-dark)] px-2 py-1 rounded">
                    2022 - 2024
                  </span>
              ...
              <div className="flex items-center gap-2 text-[var(--cv-green)] text-sm pl-4">
